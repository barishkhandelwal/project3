...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <div style="font-size: large; background-color: #FFFFFF; color: #000080;">
        <asp:Menu ID="Menu1" runat="server" Font-Underline="True" ForeColor="#000099" 
            ...
            <Items>
                <asp:MenuItem Text="Student Corner" Value="Student Corner">
                    ...
                    <asp:MenuItem Text="Virtual Labs" Value="Virtual Labs"></asp:MenuItem>
                </asp:MenuItem>
            </Items>
        </asp:Menu>
